 ...
 * @author Admin
 */
public class SupprimerManga extends javax.swing.JFrame {

    /**
     * Creates new form SupprimerManga
     */
    public SupprimerManga() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Supprimer Manga");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(250, 30, 290, 60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupprimerManga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupprimerManga().setVisible(true);
            }
        });
    }
