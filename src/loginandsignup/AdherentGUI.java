...
public class AdherentGUI extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        FavorisGUI FavorisFrame = new FavorisGUI();
        FavorisFrame.setVisible(true);
        FavorisFrame.pack();
        FavorisFrame.setLocationRelativeTo(null);
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        EmpruntsGUI EmpruntsFrame = new EmpruntsGUI();
        EmpruntsFrame.setVisible(true);
        EmpruntsFrame.pack();
        EmpruntsFrame.setLocationRelativeTo(null);
        this.dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        KindlesGUI KindlesFrame = new KindlesGUI();
        KindlesFrame.setVisible(true);
        KindlesFrame.pack();
        KindlesFrame.setLocationRelativeTo(null);
        this.dispose();
